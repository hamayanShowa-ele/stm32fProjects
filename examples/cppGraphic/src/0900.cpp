...
/* ----------------------------------------
    gpio initialize
---------------------------------------- */
void BOARD_0900::gpioInit()
{
  /* all pin make input pullup. */
  GPIO_InitTypeDef GPIO_InitStruct;

  /* The maximum port on the STM32F103VET will be PE */
  /* Changed all terminal settings to include input and pull-up */
...
---------------------------------------- */
void BOARD_0900::busPortInitialize()
{
...
---------------------------------------- */
void BOARD_0900::glcdInterruptInit()
{
...
---------------------------------------- */
void BOARD_0900::glcdSleep( bool onOff )
{
  if( onOff ) set( PWRSVE );
  else reset( PWRSVE );
}
